...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Top Bar */}
      <header className="border-b border-terminal-border px-4 py-2.5 flex items-center justify-between bg-terminal-surface/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5">
            <Activity size={16} className="text-terminal-blue animate-glowPulse" />
        ...
        <nav className="flex items-center gap-1">
          {TABS.map(t => (
            ...
            >
              {t}
              {tab === t && (
                <span className="absolute bottom-0 left-2 right-2 h-0.5 rounded-full bg-terminal-blue" />
              )}
            </button>
          ))}
        </nav>
      ...
      <footer className="border-t border-terminal-border bg-terminal-surface/60">
        <div className="flex items-center">
          ...
          <div className="overflow-hidden flex-1">
            <div className="animate-ticker py-1.5 text-xs text-terminal-dim">
              {[
